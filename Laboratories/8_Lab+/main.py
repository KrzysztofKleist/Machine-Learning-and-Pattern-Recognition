...
if __name__ == '__main__':
    ...
    Cfn = 1
    Cfp = 1
    Pred = assign_labels(llrs, pi, Cfn, Cfp)

    print(compute_conf_matrix_binary(Pred, Labels))
    ...
    Pred = assign_labels(llrs, pi, Cfn, Cfp)
    CM = compute_conf_matrix_binary(Pred, Labels)
    print(compute_emp_Bayes_binary(CM, pi, Cfn, Cfp))
    ...
    Cfn = 1
    Cfp = 1
    print(compute_act_DCF(scores, Labels, pi, Cfn, Cfp))
    ...
    Cfn = 1
    Cfp = 1
    print(compute_min_DCF(scores, Labels, pi, Cfn, Cfp))
